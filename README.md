...
* **Files:** `Emails_Sent_by_Month`, `Emails_Sent_by_Month_with_CTEs`
...
* **File:** `Revenue_by_Device_and_Continent_with_Sessions`
...
* **File:** `Top_10_Countries_Email_Metrics_Module_Task`
